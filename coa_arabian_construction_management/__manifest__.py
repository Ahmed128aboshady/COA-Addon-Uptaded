# -*- coding: utf-8 -*-
{
    ...
    'price': 79.0,
    'currency': 'EUR',
    'depends': ['base', 'hr', 'uom', 'account', 'purchase', 'utm', 'project', 'coa_arabian_cheque_management', 'coa_arabian_requisition', 'stock', 'coa_arabian_letters_of_guarantee', 'documents', 'coa_arabian_expense_payment', 'coa_arabian_res_partner', 'hr_timesheet'],
