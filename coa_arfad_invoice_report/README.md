# Arfad Custom Invoice Report (`arfad_invoice_report`)
...
- **الاسم الفني (Technical Name):** `arfad_invoice_report`
...
3. البحث عن `Arfad Custom Invoice Report` أو `arfad_invoice_report` والضغط على **تثبيت (Install)**.
