# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Print the Sale Order invoice(s) directly from the SO with one click. '
               'Opens the browser print dialog immediately (no download). '
               'Works for Sales users without Accounting access.',
    'description': """
