...
class AccountInvoice(models.Model):
    ...
    sh_pdc_status = fields.Selection([('draft', 'Draft'), ('registered', 'Registered'), ('returned', 'Returned'),
                              ('deposited', 'Deposited'), ('bounced', 'Bounced'), ('done', 'Done'), ('cancel', 'Cancelled')], string="PDC Status", compute='_compute_latest_pdc_payment_status', search='_search_latest_pdc_payment_status')
    ...
    def js_assign_outstanding_line(self, line_id):
        ...
        for invoice in self:
            ...
            pdc = payment_move.pdc_id
            if pdc:
                pdc.invoice_ids = [(4, invoice.id)]
