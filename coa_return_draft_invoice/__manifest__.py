# -*- coding: utf-8 -*-
{
    ...
    'summary': 'When a warehouse return of a Sale Order is validated, the linked '
               'DRAFT customer invoice is automatically reduced by the returned '
               'quantities. Audit-trail safe (never touches posted entries).',
    'description': """
