...
class CoaAccountMergeWizard(models.TransientModel):
    _name = 'coa.account.merge.wizard'
    ...
    def action_merge(self):
        ...
        _logger.info(
            'COA Account Merge: %s merged into %s (%s journal items) '
            'by user %s',
    ...
    def _update_company_dependent_fields(self, sources, destination):
        ...
        as jsonb {company_id: account_id} since Odoo 17 - the FK scan
