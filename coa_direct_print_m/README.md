# COA Direct Print - SO / Invoice / Customer Statement (`coa_direct_print_m`)
...
- **الاسم الفني (Technical Name):** `coa_direct_print_m`
...
3. البحث عن `COA Direct Print - SO / Invoice / Customer Statement` أو `coa_direct_print_m` والضغط على **تثبيت (Install)**.
