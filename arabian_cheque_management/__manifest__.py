# -*- coding: utf-8 -*-
{
    ...
    'summary': 'Professional Arabian Cheque Management solution for Odoo Accounting. Streamlines business operations, automates workflow validations, and enhances ERP reporting.',
    'description': 'COA Arabian Cheque Management developed by COA Egypt (https://www.coa-egy.com). Fully integrated for Odoo 17.0.0.1.',
